...
import { useGetColumns } from "@/app/entities/products/productListTable/hooks";
import type { TProductListItem } from "@/app/api/adminPanel/products/list/types";
import type { TTableColumn } from "@/app/entities/products/productListTable/types";
    ...
    return (
      <div ref={ref}>
        <UiTable<TProductListItem>
          ...
          totalItemsTitle={t("pages.adminPanel.productList.table.header") ?? "Total products"}
        />
      </div>
    );
  },
...
TableComponent.displayName = "ProductListListTableComponent";

export const ProductListTable = memo(TableComponent);
