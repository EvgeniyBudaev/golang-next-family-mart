...
import type { TModifiers, TPlacement } from "@/app/uikit/components/tooltip/types";
import "./Tooltip.scss";
import { getTooltipOffset } from "@/app/uikit/components/tooltip/utils";
      ...
      {isHydrated &&
        ...
        ReactDOM.createPortal(
          <div
            ...
            {...attributes.popper}
          >
            <div className="Tooltip-ElementInner">
              {message}
